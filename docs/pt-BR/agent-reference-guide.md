...
- [Story 1.8](./stories/1.8-phase-3-workflow-orchestration.md) - Implementação de orquestração de workflow
- [Story 1.9](./stories/1.9-missing-pv-agents.md) - Criação de agentes ausentes (esta implementação)
